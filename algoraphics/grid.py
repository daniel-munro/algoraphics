...
grid.py
=======
Functions for grids, including creating maze-like patterns.
...
def grid_tree_edges(rows: int, cols: int) -> Sequence[Tuple[Tuple[int, int],
                                                            Tuple[int, int]]]:
...
def maze(rows: int, cols: int, spacing: Number, start: Point, style:
         Maze_Style) -> dict:
...
def fill_maze_hue_rotate(outline: Collection, spacing: Number, style:
                         Number, color: Color) -> dict:
