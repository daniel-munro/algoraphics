...
ag.write_SVG(x, w, h, 'svg/structures1.svg')
ag.to_PNG('svg/structures1.svg', 'png/structures1.png')
...
ag.write_SVG(x, w, h, 'svg/structures2.svg')
ag.to_PNG('svg/structures2.svg', 'png/structures2.png')
...
ag.write_SVG(x, w, h, 'svg/structures3.svg')
ag.to_PNG('svg/structures3.svg', 'png/structures3.png')
...
ag.write_SVG([x1, x2, y, z], w, h, 'svg/structures4.svg')
ag.to_PNG('svg/structures4.svg', 'png/structures4.png')
